...
public class IpV4Util {
    ...
    public IpV4Util() {
        int maskLen =0;
        try {
            maskLen =getLocalMask().get(0).getNetworkPrefixLength();
    ...
    public static List<InterfaceAddress> getLocalMask() throws UnknownHostException, SocketException {
